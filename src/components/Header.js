...
const Header = ( {isOpen, toggle} ) => {
  ...
  return (
    <header className='flex justify-between items-center h-16 bg-blue-800 text-white fixed z-50 w-full -top-0'>
      <h1><NavLink to='/' className='flex items-center font-extrabold text-white no-underline hover:text-white hover:no-underline px-4 text-xl'>Melon Special</NavLink></h1>
